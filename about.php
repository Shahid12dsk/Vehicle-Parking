            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <p>By: Md Shahid Khan.P(1JB18CS175) </p>
                        </div>
                        <div class="card-body">
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div>
<p style="color:black">Vehicle Parking Database system for managing the records of the incoming and outgoing vehicles in an parking house.It’s easy for Admin to retrieve the data if the vehicle has been visited through number he can get that data.</p>
